...
def raiseticket(emailid, issue, t_id):
                                        ...
                                        <h2>Status : Resolving....</h2>
                                            ...
                                            <td valign="middle" width="50%">
                                                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                                    <tr>
                                                        <td>
                                                            <img src="2.jpg" alt="" style="width: 100%; max-width: 150px; height: auto; margin: auto; display: block;">
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
    ...
    msg['From'] = config["DEFAULT"]["email send"]
    msg['To'] = emailid
    password = config["DEFAULT"]["email send pass"]
